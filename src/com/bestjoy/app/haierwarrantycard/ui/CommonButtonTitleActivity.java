...
public abstract class CommonButtonTitleActivity extends FragmentActivity implements View.OnClickListener{
	...
	public static final int DIALOG_DATA_NOT_CONNECTED = 10006;//当前没有网络对话框
	public static final int DIALOG_MOBILE_TYPE_CONFIRM = 10007;//创建正在使用移动网络提示对话框
	/**
	 * 图库获取到了照片
	 * @param uri 返回获取到的图片的Uri
	 * @return
	 */
