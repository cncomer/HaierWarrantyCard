...
public class RegisterActivity extends CommonButtonTitleActivity implements OnTouchListener{
			...
			case R.id.edit_city:
				...
				case MotionEvent.ACTION_UP:
					if(mProName != null) {						
						...
						Toast.makeText(RegisterActivity.this, R.string.input_province_tips, Toast.LENGTH_SHORT).show();
					}
					break;
			}
				break;
			case R.id.edit_district:
				...
				case MotionEvent.ACTION_UP:
					if(mCityName != null) {					
						...
						Toast.makeText(RegisterActivity.this, R.string.input_city_tips, Toast.LENGTH_SHORT).show();
					}
					break;
			}
				break;
